    ...
    render() {
        return (
            <div className='statContainer'>
                ...
                {this.state.totalPortfolio.toFixed(2) + ' €'}
                <h3>Total Dividends</h3>
                {this.state.totalDividends.toFixed(2) + ' €'}
                <h3>Dividend %</h3>
                {this.state.divPercent.toFixed(2) + '%'}
                <h3>Payout Ratio</h3>
                {this.state.payOutRatio.toFixed(2) + '%'}
                <h3>PE ratio</h3>
                {this.state.peRatio.toFixed(2)}
